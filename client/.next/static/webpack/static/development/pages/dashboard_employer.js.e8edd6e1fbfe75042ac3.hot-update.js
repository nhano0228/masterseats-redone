...
const FindDesigners = props => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    Object(_lib_server__WEBPACK_IMPORTED_MODULE_1__["getGradedDesigners"])(id).then(async commList => {
      const updatedList = await lodash__WEBPACK_IMPORTED_MODULE_6___default.a.map(commList, async user => {
        let profilePic = '';
      ...
      console.log(updatedList); //setDesignerList(updatedList)
    });
  }, [currentUser]);
...
//# sourceMappingURL=dashboard_employer.js.e8edd6e1fbfe75042ac3.hot-update.js.map