...
const FormPersonalData = props => {
  ...
  const onFinish = values => {
    ...
    if (profilePic === undefined) {
      ...
      _lib_firebase__WEBPACK_IMPORTED_MODULE_5__["storage_ref"].child('profilePic/' + currentUser.id + '.jpg').put(profilePic.file["originFileObj"]).then(snapshot => {
        updateUser(values);
      });
    }
  };
...
//# sourceMappingURL=onboarding.js.c6321f1cb8b3f6e46ed8.hot-update.js.map