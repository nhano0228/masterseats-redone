...
const FormPersonalData = props => {
  ...
  const onFinish = values => {
    ...
    if (profilePic === undefined) {
      ...
      _lib_firebase__WEBPACK_IMPORTED_MODULE_5__["storage_ref"].child('profilePic/' + currentUser.id + '.png').put(profilePic.file["originFileObj"]).then(snapshot => {
        updateUser(values);
      });
    }
  };
...
//# sourceMappingURL=onboarding.js.047743f15a4909232042.hot-update.js.map